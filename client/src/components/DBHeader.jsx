  ...
  return (
    <div className=' flex w-full items-center justify-between gap-3'>
        ...
        <div className=' flex items-center justify-center gap-4'>
            <div className=' flex items-center justify-center gap-4 px-4 py-2 bg-white backdrop-blur-md shadow-md rounded-md'>
            ...
            <div className=' flex items-center justify-center gap-2'>
                <div className=' w-10 h-10 rounded-md shadow-md overflow-hidden cursor-pointer'>
                    <motion.img 
